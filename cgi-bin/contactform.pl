...
my $HTML_thankyou            = 'http://aspiredcreativity.com/formthanks.html';
my $to                       = 'kjackson@aspiredcreativity.com';
my $from                     = 'kjackson@aspiredcreativity.com';
my $mailprog                 = '/usr/sbin/sendmail';
my $subject                  = 'Contact Form Post from Aspired Creativity';
##################################################################################
# 
